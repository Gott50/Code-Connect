...
export const EXAMPLE_ACTION_1 = "Button/EXAMPLE_ACTION_1";
export const EXAMPLE_ACTION_2 = "Button/EXAMPLE_ACTION_2";
export const EXAMPLE_ACTION_3 = "Button/EXAMPLE_ACTION_3";
